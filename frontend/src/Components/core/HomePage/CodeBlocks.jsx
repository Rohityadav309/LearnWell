  ...
  return (
    <div className={`flex ${position} my-20 justify-between gap-10 flex-wrap `}>
      ...
      <div className=" h-fit  flex flex-row text-10[px] w-[100%] py-3 lg:w-[500px] glass ">
        ...
        <div className="text-center flex flex-col w-[10%] text-richblack-400 font-inter font-bold mt-1.5 leading-relaxed">
          <p>1</p>
          <p>2</p>
          <p>3</p>
          <p>4</p>
        ...
        <div
          className={`w-[90%] flex flex-col  font-bold font-mono ${codeColor} pr-2 relative leading-relaxed`}
        >
