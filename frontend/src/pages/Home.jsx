...
<nav><a href="one/">One</a><a href="two/">Two</a><a href="three/">Three</a>
        ...
        <div className="w-11/12 mx-auto max-w-maxContent flex-col  items-center justify-between first-letter bg-richblack-900 text-white">
          <InstructorSection />
          {/* <div className="lg:h-[150px] text-white"></div> */}
          <ExploreMore />
          {/* Review Slider here */}
        </div>
      </div>
